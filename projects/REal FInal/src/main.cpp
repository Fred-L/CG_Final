...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		BackendHandler::imGuiCallbacks.push_back([&]() {
			...
			if (ImGui::CollapsingHeader("CG Final Effects Buttons"))
			{
		...
		Texture2D::sptr stone = Texture2D::LoadFromFile("images/snow.jpg");
		...
		Texture2D::sptr Dunce = Texture2D::LoadFromFile("images/Dunce.png");
		...
		ShaderMaterial::sptr DunceMat = ShaderMaterial::Create();
		DunceMat->Shader = shader;
		DunceMat->Set("s_Diffuse", Dunce);
		DunceMat->Set("s_Specular", noSpec);
		DunceMat->Set("u_Shininess", 8.0f);
		DunceMat->Set("u_TextureMix", 0.0f);
		...
		{
			VertexArrayObject::sptr vao = ObjLoader::LoadFromFile("models/Dunce_1.obj");
			obj2.emplace<RendererComponent>().SetMesh(vao).SetMaterial(DunceMat);
